...
from PerplexityLab.visualization import generic_plot, LegendOutsidePlot, perplex_plot, make_data_frames
...
model_style = OrderedDict([
    ...
    ("node_linear_TWHW", PlotStyle(color=cgreen, marker="o", linestyle="--", linewidth=2)),
    # ("node_nn_TWHW", PlotStyle(color=cgreen, marker="o", linestyle="-", linewidth=2)),
    # ("node_RF_TWHW", PlotStyle(color=cgreen, marker="o", linestyle="-.", linewidth=2)),

    # ("geometrical_linear_TWHW", PlotStyle(color=cpurple, marker="o", linestyle="--", linewidth=2)),
    # ("geometrical_nn_TWHW", PlotStyle(color=cpurple, marker="o", linestyle="-", linewidth=2)),
    ("geometrical_RF_TWHW", PlotStyle(color=cpurple, marker="o", linestyle="-.", linewidth=2)),

    ("pca_linear_TWHW", PlotStyle(color=cblue, marker="o", linestyle="--", linewidth=2)),
    # ("pca_nn_TWHW", PlotStyle(color=cblue, marker="o", linestyle="-", linewidth=2)),
    # ("pca_RF_TWHW", PlotStyle(color=cblue, marker="o", linestyle="-.", linewidth=2)),
...
plot_estimation_histogram(
    ...
    # name="plot_map_1AM",
    time=pollution_future.index[25],
    name="histogram_of_pollution_predictions_8AM",
    individual_models=list(model_style.keys())[2:6],
